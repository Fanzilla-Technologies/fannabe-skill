...
- `ai schema <id> --concept-type <type>` shows fields for a specific concept (e.g. `single-image`, `carousel`, `video-from-image`, `talking-video`). `--simple` shows the simple-mode fields.
